...
-  The topics that are covered in this course are set theory, proof techniques, relations, functions, recurrence relations, counting methods, graph theory, trees and finite automata.
...
---
- CLO1 - Analyse set theory, proof techniques, relations, functions and recurrence relation to solve computer science problems.>
- CLO2 - Explain and solve the problem of counting using counting methods.>
- CLO3 - Apply the graph theory and trees in real world problems.
- CLO4 - Identify deterministic finite automata and finite state machines to model certain electronic devices.
---
## 📖 Chapter
---
